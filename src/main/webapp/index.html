...
<head>
    <meta charset="utf-8" />
    <title>Page de liens — nex.html</title>
</head>
<body>
...
<ul>
    ...
    <li><a href="nonexistent">Lien inexistant (devrait déclencher FrontServlet)</a></li>
    <li><a href="/some/absolute/path.html">Chemin absolu simulé (ex: /some/absolute/path.html)</a></li>
</ul>
</body>
</html>
